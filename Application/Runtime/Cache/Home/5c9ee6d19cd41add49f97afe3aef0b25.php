    ...
    <body>
        ...
        <div id="content" style="padding-top:20px;">
            ...
            <div id="member_box" class="member_box">
                <div class="absolute"><img src="/Public/Home/img/login_bg.png" /></div>
                <form id="dologin" action="./login_files/login.htm" method="post" onsubmit="return checklogin('dologin');">
                    <div id="login_box_n">
                        <div class="input_zone">
                            <div class="input_l"><i>手机/邮箱：</i></div>
                            <div class="input_r">
                                <input class="input_large_en" type="text" id="usernme" name="username" texttype="text" value="" backtext1="请输入注册时的邮箱或手机号码。" regxe="/(^([a-zA-Z0-9._-])+@([a-zA-Z0-9._-])+(.[a-zA-Z]{2,3})$)|(^0?(13[0-9]|15[012356789]|18[012356789]|14[0-9]|17[0-9])[0-9]{8}$)/" backtext2="请输入正确的邮箱地址或11位手机号码。" />
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="input_zone">
                            <div class="input_l"><i>密　 　码：</i></div>
                            <div class="input_r">
                                <input class="input_large_en" type="password" id="password" name="password" texttype="text" backtext1="请输入您的密码。" />
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="input_zone meici_tag clearfix">
                            <div class="input_r">
                                <input id="login_re" name="autoLogin" class="input_small float_l" value="1" type="checkbox" checked="checked" />
                                <label for="login_re" class="float_l">下次自动登录</label>
                                <a class="float_r" href="/index/forgotpass.html" target="_blank">忘记密码？</a>
                            </div>
                        </div>
                        <div class="input_zone meici_tag clearfix">
                            <div class="input_r">
                                <button class="btn_login" type="submit">登录</button>
                                <div style="margin-top:5px; text-align:right;"><a href="/member/register.html" style="color:#8e0c3a; margin:0 0 0 55px; line-height:2.2;">立即注册</a></div>
                                <p class="clear" id="errormsg"></p>
                            </div>
                        </div>
