...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
            <li class="click"><a href="<?php echo U('tianjia');?>"><span><img src="/Public/Admin/images/t01.png" /></span>添加</a></li>
            <li class="click"><a href="<?php echo U('upd');?>"><span><img src="/Public/Admin/images/t02.png" /></span>修改</a>></li>
